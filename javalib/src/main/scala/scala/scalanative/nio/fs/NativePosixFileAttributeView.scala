...
final class NativePosixFileAttributeView(path: Path, options: Array[LinkOption])
  ...
  private def getGroup(name: CString)(implicit z: Zone): Option[Ptr[grp.group]] = {
  ...
  private def getGroup(gid: stat.gid_t)(implicit z: Zone): Option[Ptr[grp.group]] = {
    val buf = alloc[grp.group]
  ...
  private def getPasswd(name: CString)(implicit z: Zone): Option[Ptr[pwd.passwd]] = {
  ...
  private def getPasswd(uid: stat.uid_t)(implicit z: Zone): Option[Ptr[pwd.passwd]] = {
    val buf = alloc[pwd.passwd]
